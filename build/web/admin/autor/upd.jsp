...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="AutorCtl" method="post">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="txtNacionalidade" value="<c:out value="${obj.getNacionalidade()}"/>" required />
                    </div>
                    <div class="form-group">
                        <label>Descrição</label>
                        <input class="form-control" type="text" name="txtDescricao" value="<c:out value="${obj.getDescricao()}"/>" required />
                    </div>
